...
- The file [climate_script.r](scripts/climate_script.r) contains the scripts for data visualization of the diurnal temperature and relative humidity for the growth temperatures (37°C, 30°C, and 23°). Data was recorded with the HOBO sensors.
